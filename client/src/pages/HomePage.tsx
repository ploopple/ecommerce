      ...
      <main className='w-full h-[94vh]'>
        <div className='w-full h-full flex'>
         {allProducts.map((product: any) => ( 
          <div key={product.id} className='border rounded-xl w-max h-max my-6 ml-6 flex flex-col '>
            ...
            <div className='p-2 w-full '>
              ...
              <button className=' bg-orange-500 text-white rounded-md px-2'>Add to cart</button>
              </div>
            </div>
          </div>
        ))}
